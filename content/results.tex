...
\Figure{H}{0.9}{fig:1}{History plot of Bayesian optimization}{ - The loss value of each trial}{content/Plots/history_plot_bay_final.png}
\Figure{H}{0.9}{fig:2}{History plot of random search}{ - The loss value of each trial}{content/Plots/history_plot_random_final.png}
...
\Figure{H}{0.9}{fig:3}{Parallel coordinate plot of Bayesian optimization}{ - All tested hyperparameter combinations are visualized together with the achieved loss value.}{content/Plots/parallel_coordinate_plot_bayesian.png}
\Figure{H}{0.9}{fig:4}{Parallel coordinate plot of random search}{ - All tested hyperparameter combinations are visualized together with the achieved loss value.}{content/Plots/parallel_coordinate_plot_random.png}
...
\Figure{H}{0.9}{fig:5}{Parameter importance plot of Bayesian optimization}{ - The importance of every optimized hyperparameter on the loss value.}{content/Plots/param_importances_plot_bayesian.png}
\Figure{H}{0.9}{fig:6}{Parameter importance plot of random search}{ - The importance of every optimized hyperparameter on the loss value.}{content/Plots/param_importance_random.png}
...
\Figure{H}{0.9}{fig:7}{Loss plot}{ - Training and validation loss for each epoch.}{content/Plots/performance/loss_plot.png}
\Figure{H}{0.9}{fig:8}{Accuracy plot}{ - Training and validation accuracy for each epoch.}{content/Plots/performance/acc_plot.png}
...
\Figure{H}{0.9}{fig:10}{ROC one vs. all}{}{content/Plots/performance/roc_plot.png}
...
\Figure{H}{0.9}{fig:11}{ROC one vs. all}{}{content/Plots/performance/combined_roc_curves.png}
...
\Figure{H}{0.9}{fig:12}{Confusion matrix with a threshhold of $0.5$}{- Weight increase of $3$}{content/Plots/performance/cm_plot_cw_3.png}
