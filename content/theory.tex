...
\begin{fmffile}{feynman}
    \fmfset{curved}{tension=1.0}
    \fmfset{dot_size}{thick}
    ...
    \begin{fmfgraph*}(150,100)
      ...
      \fmf{fermion, tension=1.0}{v2, v1}
      
      % Higgs boson emission
      \fmf{dashes, tension=0.5}{v1, o1}
      \fmf{dashes, tension=0.5}{v1, o2}
      
      % Higgs boson decays into two Higgs bosons
      \fmf{dashes, tension=0.5}{o1, o2}
      \fmf{dashes, tension=0.5}{o2, o1}
      
      % Label the particles
      \fmflabel{Gluon 1}{i1}
      \fmflabel{Gluon 2}{i2}
      \fmflabel{Top quarks}{v1}
      \fmflabel{Higgs}{v2}
      \fmflabel{Higgs 1}{o1}
      \fmflabel{Higgs 2}{o2}
    \end{fmfgraph*}
